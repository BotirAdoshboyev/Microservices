...
interface InfoService {
    ...
    fun findFullInfoByResidentId(id: Long) : InfoDto
}
...
class InfoServiceImpl(
    ...
    override fun findFullInfoByResidentId(id: Long) = InfoDto.toDto(fullInfoRepository.findFullInfoByResidentId(id))
}
